...
export function HeroSection() {
  ...
  return (
    <section className="py-12 w-full flex justify-center items-center px-4 md:px-6">
      ...
      >
        <div className="relative overflow-hidden rounded-[48px] border border-gray-700 bg-gray-800 shadow-2xl min-h-[600px] md:min-h-[600px] flex flex-col items-center justify-center duration-500">
          <Suspense
            fallback={<div className="absolute inset-0 bg-gray-900/20" />}
          >
