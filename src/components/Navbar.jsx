          ...
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              <Link to="/admin/dashboard" className="text-xl font-semibold text-white">
                BVRIT Hackathon <span className="text-orange-500">Admin</span>
              </Link>
        ...
        {isOpen && (
          <div className="md:hidden bg-gray-800 border-t border-gray-700">
            <div className="px-2 pt-2 pb-3 space-y-1">
              <Link to="/admin/dashboard" className="block px-3 py-2 text-sm font-medium text-gray-400 hover:text-white hover:bg-gray-700 rounded">Dashboard</Link>
              <Link to="/admin/applications" className="block px-3 py-2 text-sm font-medium text-gray-400 hover:text-white hover:bg-gray-700 rounded">Applications</Link>
              <Link to="/" className="block px-3 py-2 text-sm font-medium text-gray-400 hover:text-white hover:bg-gray-700 rounded">View Site</Link>
              <button onClick={handleLogout} className="block w-full text-left px-3 py-2 text-sm font-medium text-gray-400 hover:text-white hover:bg-gray-700 rounded">Logout</button>
            </div>
          </div>
        )}
      </nav>
